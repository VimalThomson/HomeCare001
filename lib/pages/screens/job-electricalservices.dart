...
import '../userscreens/pendingrequests.dart';
...
class ElectricalServices extends StatefulWidget {
  ...
  @override
  _ElectricalServicesState createState() => _ElectricalServicesState();
}
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ClipRRect(
                            ...
                            child: Image.asset('assets/images/p_electric.jpg', fit: BoxFit.cover,
                          ...
                          Text("The offered service is executed by highly qualified professionals using premium grade machines and latest technology, they, properly examine all the parameters associated to this service and carry out it in the best possible manner.", style: TextStyle(fontSize: 20),),
                          SizedBox(height: 20.0),
                          ...
                          DropdownButtonFormField(
                            ...
                            items: <String>['Air Conditioner', 'Microwave', 'Refrigerator', 'Washing Machine', 'Water Purifier','Television', 'Geyser', 'Other']
