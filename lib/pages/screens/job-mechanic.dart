                        ...
                        children: <Widget>[
                          ClipRRect(
                           ...
                           // child: Image.network('https://c.tenor.com/xtfyT5uZdIwAAAAS/naperville-auto-repair-service-auto-body-repair-naperville.gif', fit: BoxFit.cover),
                            child: Image.asset('assets/images/p_mechanic.png', fit: BoxFit.cover,
                          ...
                          Text("Get instant on-the-spot support for breakdown & starting problem issues due to mechanical issues, electrical issues, spark plug problems, battery problems, fuse problems, wheel problems, etc from experienced Mechanics. ", style: TextStyle(fontSize: 20),),
                          SizedBox(height: 20.0),
                          ...
                          DropdownButtonFormField(
                            ...
                            items: <String>['Spark plug problems', 'Battery problems', 'Wheel problems', 'Cable problems', 'Fuel tappet problems']
