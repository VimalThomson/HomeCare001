...
class WorkDescValidator {
  static String? validate(String value) {
    if (value.length == 0) {
      return "Can't be empty";
    }
    if(!(value.isEmpty) && !RegExp(r"(\b((?!=|\,|\.).)+(.)\b)").hasMatch(value)){
      return "Not Valid";
    }
  }
}
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          ClipRRect(
                            ...
                            child: Image.asset('assets/images/p_carpenter.webp', fit: BoxFit.cover,
                          ...
                          Text("HomeCare provides skilled and reliable carpenters that provide quality workmanship at cost you can easily afford. HomeCare offers a comprehensive range of carpentry services from general carpentry, door repair, window repair, lock installation, new furniture making, furniture repair & installation. ", style: TextStyle(fontSize: 20),),
                          SizedBox(height: 20.0),
                          ...
                          TextFormField(
                            ...
                            //   return null;
                            // },
                            validator:(value)=> WorkDescValidator.validate(value!),
                          ...
                          DropdownButtonFormField(
                            ...
                            // validator:(value)=> WorkTypeValidator.validate(value),

                            value: worktype.isNotEmpty ? worktype : null,
                            items: <String>['General carpentry', 'Door/Window repair', 'Lock installation/repair', 'Furniture repair', 'Furniture making']
